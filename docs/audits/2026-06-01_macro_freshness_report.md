...
Probe vs `http://localhost:3000`. Catálogos: 15. Indicadores: 277.
...
|---|---:|---:|---:|---:|---:|
| cultura-ocio | 9 | 1 | 9 | 0 | 19 |
| demografia-territorio | 8 | 1 | 11 | 0 | 20 |
| dependencias-externas | 6 | 2 | 6 | 0 | 14 |
| empresas-beneficios | 2 | 1 | 10 | 0 | 13 |
| flujos-capital | 2 | 0 | 8 | 1 | 11 |
| hogares-empleo-vivienda | 5 | 11 | 16 | 0 | 32 |
| instituciones-estado | 17 | 0 | 9 | 0 | 26 |
| margen-fiscal | 10 | 3 | 3 | 0 | 16 |
| medio-rural | 11 | 0 | 24 | 1 | 36 |
...
| cultura-ocio | `co-cooperativas-activas` | `/api/spanish-stats/cooperativas?country=ESP` | sin puntos |
| cultura-ocio | `co-cult-trade` | `/api/eurostat/dataset?code=cult_trd1&filters=geo=ES` | sin puntos |
| cultura-ocio | `co-empleo-economia-social` | `/api/spanish-stats/empleo-eco-social?country=ESP` | sin puntos |
| cultura-ocio | `co-gasto-hogares-cultura` | `/api/spanish-stats/gasto-hogares-cult?country=ESP` | sin puntos |
...
| cultura-ocio | `co-pib-economia-social` | `/api/spanish-stats/pib-eco-social?country=ESP` | sin puntos |
| cultura-ocio | `co-tourism-nights-eurostat` | `/api/eurostat/dataset?code=tour_occ_nin&filters=geo=ES;c_res` | sin puntos |
| demografia-territorio | `dt-cohorte-mujer-edad-fertil` | `/api/spanish-stats/edad-maternidad?country=ESP` | sin puntos |
| demografia-territorio | `dt-crecimiento-natural` | `/api/spanish-stats/crecimiento-natural?country=ESP` | sin puntos |
| demografia-territorio | `dt-indice-envejecimiento` | `/api/macro/derived/envejecimiento_idx` | sin puntos |
| demografia-territorio | `dt-municipios-despoblacion` | `/api/spanish-stats/municipios-despoblacion?country=ESP` | sin puntos |
| demografia-territorio | `dt-pob-extranjera` | `/api/spanish-stats/pob-extranjera?country=ESP` | sin puntos |
...
| demografia-territorio | `dt-proyeccion-pob-2050` | `/api/spanish-stats/proyeccion-pob?country=ESP` | sin puntos |
...
| hogares-empleo-vivienda | `hev-esfuerzo-vivienda` | `/api/spanish-stats/esfuerzo-vivienda?country=ESP` | sin puntos |
...
| hogares-empleo-vivienda | `hev-precio-m2-vivienda` | `/api/spanish-stats/precio-m2-vivienda?country=ESP` | sin puntos |
| hogares-empleo-vivienda | `hev-renta-disponible-pc` | `/api/eurostat/dataset?code=nasa_10_ki&filters=geo=ES;sector=` | sin puntos |
| hogares-empleo-vivienda | `hev-salario-mediano` | `/api/spanish-stats/salario-mediano?country=ESP` | sin puntos |
| hogares-empleo-vivienda | `hev-salario-medio` | `/api/spanish-stats/salario-medio?country=ESP` | sin puntos |
| hogares-empleo-vivienda | `hev-smi` | `/api/spanish-stats/smi?country=ESP` | sin puntos |
| hogares-empleo-vivienda | `hev-smi-mediano-ratio` | `/api/spanish-stats/kaitz-ratio?country=ESP` | sin puntos |
...
| instituciones-estado | `ie-contratacion-publica` | `/api/spanish-stats/contratacion-pub?country=ESP` | sin puntos |
| instituciones-estado | `ie-ejecucion-presup` | `/api/spanish-stats/ejecucion-presup?country=ESP` | sin puntos |
...
| medio-rural | `mr-banda-ancha-rural` | `/api/spanish-stats/banda-ancha-rural?country=ESP` | sin puntos |
| medio-rural | `mr-indice-cohesion-terr` | `/api/macro/derived/cohesion_territorial` | sin puntos |
| medio-rural | `mr-municipios-1000` | `/api/spanish-stats/municipios-1000?country=ESP` | sin puntos |
| medio-rural | `mr-pac-fondos` | `/api/spanish-stats/pac-fondos?country=ESP` | sin puntos |
| medio-rural | `mr-pob-mun-5000` | `/api/spanish-stats/pob-mun-5000?country=ESP` | sin puntos |
| medio-rural | `mr-precio-tierra` | `/api/spanish-stats/precio-tierra?country=ESP` | sin puntos |
...
| medio-rural | `mr-ratio-pib-ccaa` | `/api/spanish-stats/ratio-pib-ccaa?country=ESP` | sin puntos |
| medio-rural | `mr-sau-eurostat` | `/api/eurostat/dataset?code=ef_lus_main&filters=geo=ES;crops=` | sin puntos |
| medio-rural | `mr-sigma-convergencia` | `/api/spanish-stats/sigma-ccaa?country=ESP` | sin puntos |
