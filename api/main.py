...
app.include_router(ports.router, tags=["ports"])  # Módulo Puertos · /api/v1/ports/*
app.include_router(sector_intel.router, tags=["sector-intel"])  # FE-Sectoriales · /api/v1/sector-intel/*
