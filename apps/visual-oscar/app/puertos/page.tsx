    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: '24px 20px' }}>
        ...
        <div style={{ marginBottom: 18, borderRadius: 14, overflow: 'hidden', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          <iframe
            src="/osint-global?embed=1&layers=maritime,ship_cargo,ship_tanker,ship_passenger,ship_fishing,ship_highspeed,ship_military,ship_other,port_container,port_commercial,port_energy,port_naval"
