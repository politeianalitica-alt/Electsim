...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    serie_deuda_publica: deuda.filter(p => p.value != null).map(p => ({ t: String(p.year), v: p.value })),
