/**
 * GET /api/entsoe/desvios?zone=ES&days=2 · Sprint Energía S3+
 *
 * Precios de desvío / imbalance (documentType A85, Balancing_MarketDocument) de
 * una zona de control UE, en €/MWh, vía ENTSO-E Transparency Platform. Envelope
...
import { fetchImbalancePrices } from '@/lib/entsoe/extended'
...
export async function GET(req: NextRequest) {
  ...
  const r = await fetchImbalancePrices(zone, periodStart, periodEnd)
