/**
 * GET /api/entsoe/prices?zone=ES&days=2 · Sprint Energía S3
 *
 * Precios mayoristas day-ahead (documentType A44) de una zona de oferta UE,
 * vía ENTSO-E Transparency Platform. Envelope estándar Politeia:
 *   { ok, data, fetched_at }  (HTTP 200 siempre, degradación en `ok:false`).
 *
...
import { fetchDayAheadPrices, periodForDays } from '@/lib/entsoe/client'
...
export async function GET(req: NextRequest) {
  ...
  const r = await fetchDayAheadPrices(zone, periodStart, periodEnd)
