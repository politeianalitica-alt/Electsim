/**
 * GET /api/licitaciones/screener/cpv
 * Top divisiones CPV por número de contratos.
 */
import { NextRequest, NextResponse } from 'next/server'
import { topCPV, type SocrataFilters } from '@/lib/socrata-catalunya'
...
export async function GET(req: NextRequest) {
  ...
  const all = await topCPV(filters, fetchLimit)
