'use client'
/**
 * Dashboard Sector Energía & Utilities
 *
 * Datos en vivo desde apidatos.ree.es (Red Eléctrica de España):
 *   - Demanda peninsular tiempo real
 *   - Mix de generación por tecnología
 *   - Precios mercado spot + PVPC
 *   - Balance mensual renovable / no renovable
 *   - Intercambios internacionales
 *   - Emisiones CO2
 *
 * Auto-refresh cada 5 min (cache CDN 10 min).
 */
