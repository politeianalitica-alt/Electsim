...
const MODULES = [
  { href: '/dosieres',            label: 'Dosieres de personas',  sub: '1.955 fichas · Congreso + Senado + 18 parlamentos autonómicos · relaciones · patrimonio', accent: '#7C2D12', tag: 'NUEVO' },
...
export default function DashboardPage() {
 ...
 <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 22, fontWeight: 700, letterSpacing: '-0.018em', margin: '0 0 4px' }}>
              1.955 dosieres · Congreso + Senado + 18 parlamentos autonómicos
 </h2>
