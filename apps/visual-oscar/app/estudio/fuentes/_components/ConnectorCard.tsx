...
import { getStatusColor, getStatusLabel, timeAgo, formatNumber, formatDuration, scheduleLabel } from '@/lib/estudio/utils'
...
export default function ConnectorCard({ source, onSync, onDelete, isSyncing }: Props) {
 ...
 <Link href={`/estudio/fuentes/${source.id}`} className={styles.btnView}>
          Ver detalle
 </Link>
 <button
          onClick={onSync}
