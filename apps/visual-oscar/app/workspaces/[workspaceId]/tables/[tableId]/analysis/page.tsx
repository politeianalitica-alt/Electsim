  ...
  if (!table) {
    return (
      <div className="flex h-full flex-col items-center justify-center">
        <p className="text-lg font-semibold text-slate-200">Dataset no encontrado</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <h1 className="text-lg font-bold text-slate-100 mt-1">Análisis · {table.name}</h1>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {numericCols.map(col => {
          ...
          return (
            <div key={col.id} className="rounded-xl border border-slate-800 bg-slate-900 p-4">
