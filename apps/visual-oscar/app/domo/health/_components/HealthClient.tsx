...
import { healthApi } from '@/lib/domo/api-client'
    ...
    <div className={styles.root}>
      ...
      <div className={styles.sprintsSection}>
        ...
        <div className={styles.sprintsTable}>
          {[
            { sprint: 1, module: 'Foundation + Sidebar',         route: '/domo' },
            { sprint: 2, module: 'Fuentes de datos',             route: '/domo/fuentes' },
            { sprint: 3, module: 'Pipelines ETL',                route: '/domo/pipeline' },
            { sprint: 4, module: 'Datasets',                     route: '/domo/dataset' },
            { sprint: 5, module: 'Dashboards constructor',       route: '/domo/dashboard' },
            { sprint: 6, module: 'Alertas + Notif + Sharing',    route: '/domo/alertas' },
            { sprint: 7, module: 'Gobernanza + AI Query',        route: '/domo/gobernanza' },
            { sprint: 8, module: 'Health + Cmd-K + Anotaciones', route: '/domo/health' },
          ].map(row => (
