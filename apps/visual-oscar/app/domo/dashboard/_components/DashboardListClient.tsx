...
import { timeAgo, formatNumber } from '@/lib/domo/utils'
  ...
  return (
    <div className={styles.root}>
      <div className={styles.header}>
        ...
        <Link href="/domo/dashboard/nuevo" className={styles.btnPrimary}>
          + Nuevo dashboard
        </Link>
      </div>
      ...
      {!isLoading && filtered.length === 0 && (
        <div className={styles.emptyState}>
          ...
          {dashboards.length === 0 && (
            <Link href="/domo/dashboard/nuevo" className={styles.btnPrimary}>Crear primer dashboard</Link>
          )}
        </div>
      )}
  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.cardActions}>
        <Link href={`/domo/dashboard/${dashboard.id}`} className={styles.btnView}>Abrir</Link>
        <Link href={`/domo/dashboard/${dashboard.id}/editar`} className={styles.btnEdit}>Editar</Link>
