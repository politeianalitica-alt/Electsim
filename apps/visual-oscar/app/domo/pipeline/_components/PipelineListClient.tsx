...
import { getStatusColor, getStatusLabel, timeAgo, formatDuration, formatNumber } from '@/lib/domo/utils'
  ...
  return (
    <div className={styles.root}>
      <div className={styles.header}>
        ...
        <Link href="/domo/pipeline/nuevo" className={styles.btnPrimary}>
          + Nuevo pipeline
        </Link>
      </div>
      ...
      {!isLoading && !isError && filtered.length === 0 && (
        <div className={styles.emptyState}>
          ...
          {pipelines.length === 0 && (
            <Link href="/domo/pipeline/nuevo" className={styles.btnPrimary}>Crear primer pipeline</Link>
          )}
        </div>
      )}
  ...
  return (
    <div className={styles.row}>
      ...
      <div className={styles.rowActions}>
        <Link href={`/domo/pipeline/${pipeline.id}`} className={styles.btnView}>Editar</Link>
        <button
          onClick={onRun}
