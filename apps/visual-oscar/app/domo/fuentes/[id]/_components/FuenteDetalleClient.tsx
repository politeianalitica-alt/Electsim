...
import { getStatusColor, getStatusLabel, timeAgo, formatNumber, formatDuration } from '@/lib/domo/utils'
  ...
  if (isError || !source) {
    return (
      <div style={{ padding: '2rem', textAlign: 'center' }}>
        ...
        <Link href="/domo/fuentes" style={{ color: 'var(--color-accent,#3b82f6)' }}>
          ← Volver a fuentes
        </Link>
      </div>
    )
  ...
  return (
    <div className={styles.root}>
      <div className={styles.breadcrumb}>
        <Link href="/domo/fuentes" className={styles.breadcrumbLink}>Fuentes</Link>
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.heroActions}>
          ...
          <Link href="/domo/fuentes" className={styles.btnBack}>← Volver</Link>
        </div>
      </div>
