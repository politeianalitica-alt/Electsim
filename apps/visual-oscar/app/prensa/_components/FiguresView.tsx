          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {active.recentTitles.length === 0 ? (
                ...
                return (
                  <CollapsibleArticle key={i} title={t.title} href={t.link} medio={t.medio} accent={c} titleSize={13}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{
                        fontSize: 11, fontWeight: 700, color: '#fff', background: c,
                        padding: '2px 8px', borderRadius: 999,
                      }}>
                        sentimiento {t.sentiment > 0 ? '+' : ''}{t.sentiment.toFixed(2)}
                      </span>
                    </div>
                  </CollapsibleArticle>
                )
