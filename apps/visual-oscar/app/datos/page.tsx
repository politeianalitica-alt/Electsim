...
const SOURCES: Source[] = [
  ...
  // ─── Macro · datos oficiales TSO (Sprint 1 arsenal) ──────────────
  {
    slug: 'imf',
    name: 'IMF DataMapper · WEO Forecast',
    category: 'macro',
    status: 'live',
    coverage: 'global',
    description: 'Fondo Monetario Internacional · World Economic Outlook (WEO) + Fiscal Monitor · 8 indicadores macro core España (PIB real, PIB nominal, IPC, paro, deuda %PIB, balance fiscal, cuenta corriente, PIB pc) con forecast 5 años.',
    why_useful: 'Datos oficiales del FMI con previsiones forward-looking 5 años. Sustituye/complementa estimaciones ad-hoc. Visible en /macro y /dashboard. Comparativa cross-country WEO disponible.',
    endpoint: 'https://www.imf.org/external/datamapper/api/v1',
    module: 'app/api/imf/[...path] · components/macro/ImfWeoForecast.tsx',
    env_var: 'ninguna · API pública',
    docs_url: 'https://www.imf.org/external/datamapper/api/help.htm',
    free_tier: 'Sin auth · sin rate limit publicado · cache 24h',
  },
  {
    slug: 'oecd',
    name: 'OECD Data API · SDMX',
    category: 'macro',
    status: 'live',
    coverage: 'global',
    description: 'OCDE oficial · datos macro nacional, productividad, fiscalidad, empleo, sociedad, industria. SDMX-JSON. 38 países OCDE + observadores.',
    why_useful: 'Indicadores armonizados OCDE (PIB growth, paro armonizado, IPC, deuda pública %PIB) más exigentes que national accounts. Drill-down /macro tab "Indicadores OECD".',
    endpoint: 'https://sdmx.oecd.org/public/rest/data',
    module: 'app/api/oecd/[...path] · components/macro/OecdMacroPanel.tsx',
    env_var: 'ninguna · API pública',
    docs_url: 'https://data-explorer.oecd.org',
    free_tier: 'Sin auth · ~20 req/min sostenibles · cache 12h',
  },
  {
    slug: 'bis',
    name: 'BIS Statistics · Banking & FX',
    category: 'macro',
    status: 'live',
    coverage: 'global',
    description: 'Bank for International Settlements · datos oficiales: Consolidated Banking Statistics (claims externos), Locational Banking, Effective Exchange Rates (broad+narrow), OTC derivatives, debt securities.',
    why_useful: 'Datos del "banco central de los bancos centrales" para /sector-banca. BIS EER es el FX efectivo de referencia mundial. Sustituye datos FX ad-hoc.',
    endpoint: 'https://stats.bis.org/api/v2/data',
    module: 'app/api/bis/[...path] · components/macro/BisBankingPanel.tsx',
    env_var: 'ninguna · API pública',
    docs_url: 'https://www.bis.org/statistics/sdmx_api.htm',
    free_tier: 'Sin auth · cache 24h',
  },
  {
    slug: 'eurostat',
    name: 'Eurostat Statistics API · JSON-stat',
    category: 'macro',
    status: 'live',
    coverage: 'eu',
    description: 'Oficina estadística europea · 4500+ datasets · PIB, empleo, industria, comercio Comext, regiones NUTS2 17 CCAA España, comparativa UE-27. JSON-stat 2.0.',
    why_useful: 'Datos armonizados UE-27. Ranking 17 CCAA por PIB pc + paro. España vs media UE. Sustituye/complementa INE en sectores donde Eurostat tiene serie homologada.',
    endpoint: 'https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data',
    module: 'app/api/eurostat/[...path] · components/macro/EurostatRegionsMap.tsx',
    env_var: 'ninguna · API pública',
  ...
  {
    slug: 'openfigi',
    name: 'OpenFIGI · Bloomberg identifiers',
    category: 'mercados',
    status: 'live',
    coverage: 'global',
    description: 'Bloomberg Open Symbology · resolver ISIN/CUSIP/SEDOL/ticker → FIGI + company name + exchange. Útil para mapear identificadores cross-broker.',
    why_useful: 'Resolución de identificadores en /investigations entity graph y /sector-banca para enlazar empresas cotizadas con sus ADRs/sucursales. Útil para Sprint 3 (Compliance).',
    endpoint: 'https://api.openfigi.com/v3',
    module: 'app/api/openfigi/[...path]',
    env_var: 'OPENFIGI_API_KEY (opcional · sin key 25/min, con key 250/min)',
    docs_url: 'https://www.openfigi.com/api',
    free_tier: 'Sin auth · cache 7d',
  },
