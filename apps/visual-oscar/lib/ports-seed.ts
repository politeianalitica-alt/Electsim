/* AUTO-GENERATED · seed catalog del módulo Puertos. NO EDITAR · regenerar con:
   .venv/bin/python -c "from etl.sources.ports.catalog import list_ports; ..." > tmp.json
   y mover a este archivo. */
export const PORTS_SEED = [
  {
    "slug": "algeciras",
    "unlocode": "ESALG",
    "name": "Algeciras (Bahía)",
    "country_iso": "ES",
    "lat": 36.1408,
    "lon": -5.4526,
    "type": "container",
...
export const VESSELS_SEED = [
  ...
  },
  {
    "imo": "IMO9389877",
    "mmsi": "538010012",
    "name": "GOLDEN OCEAN ALDEBARAN",
    "flag_iso": "MH",
    "type": "bulk",
    "dwt": 180000,
    "teu": null,
    "operator": "Golden Ocean Group",
    "built_year": 2010,
    "subtype": "Capesize"
  },
  {
  ...
  },
  {
    "imo": "IMO9706935",
    "mmsi": "224012345",
    "name": "NUEVO ANUNCIATA",
    "flag_iso": "ES",
    "type": "fishing",
    "dwt": 1800,
    "teu": null,
    "operator": "Pesquera Hermanos Salinas",
    "built_year": 2017,
