...
const PRES_CCAA: Figure[] = [
  ...
  fig({ id: 'pres-perezllorca', nombre: 'Juanfran Pérez Llorca', category: 'politico', cargo: 'President de la Generalitat', organizacion: 'Generalitat Valenciana', afiliacion: 'PP', ejeX: 38, ejeY: -10, influencia: 70, wikipedia: 'https://es.wikipedia.org/wiki/Juanfran_P%C3%A9rez_Llorca', tags: ['ccaa','valenciana','pp'], exposicion: 78 }),
  fig({ id: 'pres-mazon', nombre: 'Carlos Mazón', category: 'politico', cargo: 'Ex-President de la Generalitat (dimitió 11/2025)', organizacion: 'Generalitat Valenciana', afiliacion: 'PP', ejeX: 40, ejeY: -10, influencia: 60, wikipedia: 'https://es.wikipedia.org/wiki/Carlos_Maz%C3%B3n', tags: ['ccaa','valenciana','pp','dana','ex-presidente'], exposicion: 85 }),
