...
export const MARGEN_FISCAL_INDICATORS: PulsoIndicatorMeta[] = [
  ...
  },
  {
    ...
    frequency: "quarterly",
    description:
      "Deuda pública bruta consolidada Maastricht %PIB · Sprint W.3.1b: gov_10dd_ggdebt descatalogado por Eurostat · migrado a gov_10q_ggdebt (trimestral, mismo concepto Maastricht, datos hasta 2025-Q4 cuasi-realtime).",
    endpoint: "/api/eurostat/dataset?code=gov_10q_ggdebt&filters=geo=ES;sector=S13;unit=PC_GDP;na_item=GD",
    parser: "eurostat-simple",
    threshold: { amber: 100, red: 120, goodAbove: false },
    accent: "#0F766E",
    methodologyNote:
      "Cifra oficial UE Maastricht (notificación EDP). gov_10q_ggdebt publica trimestralmente con T+90d (más fresh que anual gov_10dd_*). Coincide con IMF GGXWDG_NGDP pero sin proyecciones — para forecast usar mf-deuda-imf.",
    releaseSchedule: "Trimestral · T+90d · ED quarterly debt notification",
    confidenceLevel: "high",
