...
export const PULSO_INDICATORS: PulsoIndicatorMeta[] = [
  ...
  // ─── Sprint N13.2 · Expansión nicho pulso-macro ─────────────────────────
  {
    ...
    family: 'sentimiento',
    label: 'Consumer Confidence Indicator (BCS)',
    shortLabel: 'Consumer CI',
    unit: '',
    decimals: 1,
    source: 'Eurostat · ei_bsco_m',
    sourceCode: 'ei_bsco_m:BS-CSMCI:ES',
    frequency: 'monthly',
    description:
      'Consumer Confidence Indicator (DG ECFIN Business and Consumer Surveys · BCS). Sprint W.3.1c: Eurostat descatalogó ei_bsei_m (ESI compuesto) · sustituido por consumer confidence (más volátil pero correlacionado, valor cero=neutralidad).',
    endpoint: '/api/eurostat/dataset?code=ei_bsco_m&filters=geo=ES;indic=BS-CSMCI;s_adj=SA',
    parser: 'eurostat-simple',
    threshold: { amber: -10, red: -20, goodAbove: true },
    accent: '#8b5cf6',
    methodologyNote:
      'BS-CSMCI = Consumer Confidence Indicator. Saldo neto (-100 a +100, 0=neutralidad). Promedio de 4 subcomponentes: situación financiera personal (12m pasados+futuros), situación económica general (12m pasados+futuros), expectativas de desempleo, ahorros futuros. Lead indicator del consumo de los hogares.',
