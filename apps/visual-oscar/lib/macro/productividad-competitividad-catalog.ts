...
export const PRODUCTIVIDAD_COMPETITIVIDAD_INDICATORS: PulsoIndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceCode: "isoc_e_dii:DII_VHIGH:ES",
    frequency: "annual",
    description:
      "% empresas con alta intensidad digital DESI. España ~30% vs UE 33% · gap especialmente en PYMES manufactura. Driver productividad TFP digital.",
    endpoint: "/api/eurostat/dataset?code=isoc_e_dii&filters=geo=ES;indic_is=DII_VHIGH",
    parser: "eurostat-simple",
