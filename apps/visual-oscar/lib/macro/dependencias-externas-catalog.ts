...
export const DEPENDENCIAS_EXTERNAS_INDICATORS: PulsoIndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceCode: "nrg_cb_gasm:IMP:G3000:ES",
    frequency: "monthly",
    description:
      "Importaciones mensuales gas natural (terajulios GCV). Tras Argelia conflict 2022, ES diversificó hacia USA LNG. Sensibilidad a precio TTF + invierno.",
    endpoint: "/api/eurostat/dataset?code=nrg_cb_gasm&filters=geo=ES;nrg_bal=IMP;siec=G3000;unit=TJ_GCV",
    parser: "eurostat-simple",
    accent: "#f59e0b",
    methodologyNote:
      "IMP = imports total (gaseoducto + LNG). siec=G3000 = Natural gas. unit=TJ_GCV (terajoules Gross Calorific Value). Sprint W.3.1c: filtro IMP_MAR_T (deprecated) → IMP+siec+unit explícitos. España tiene 6 plantas LNG (Barcelona, Bilbao, Cartagena, Huelva, Sagunto, Mugardos) — única conectividad UE sur. Re-export a Europa central 2022-23 (gas hub strategy).",
    releaseSchedule: "Mensual · T+60 días",
    confidenceLevel: "high",
