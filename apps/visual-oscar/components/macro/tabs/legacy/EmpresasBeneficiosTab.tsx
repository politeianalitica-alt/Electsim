...
export function EmpresasBeneficiosTab() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <a
        href="/macro/empresas-beneficios"
        style={{
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <p style={{ margin: 0, fontSize: 12, fontWeight: 700, letterSpacing: 0.4, color: '#7c3aed', textTransform: 'uppercase' }}>
            Vista profunda · /macro/empresas-beneficios
          </p>
          <p style={{ margin: '2px 0 0', fontSize: 12, color: '#475569' }}>
            Salud empresarial · beneficios · márgenes · costes financieros · creación/destrucción · análisis IA Groq por gráfica
          </p>
        </div>
