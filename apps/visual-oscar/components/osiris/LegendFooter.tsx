...
const LEGENDS: Legend[] = [
  ...
  { id: 'housing', title: 'Precio vivienda €/m² · ~3.500 · dato real con fuente', note: 'Dato REAL con fuente citada (pincha una ciudad para ver el enlace). España: oficial MITMA/INE + variación INE en vivo. EE.UU.: ~3.000 condados (Redfin, mediana $/pie²→€/m²). Resto del mundo: oficial/prensa/publicadores de mercado. Las localidades sin dato fiable se han eliminado.', active: (a) => a.housing_prices, items: [
