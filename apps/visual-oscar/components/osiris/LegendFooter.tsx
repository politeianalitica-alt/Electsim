...
const LEGENDS: Legend[] = [
  ...
  { id: 'housing', title: 'Precio vivienda €/m² · dato real con fuente', note: 'Dato REAL con fuente citada (pincha una ciudad para ver el enlace). España: oficial MITMA/INE + variación INE en vivo. Resto: oficial/prensa/publicadores de mercado. Las ciudades sin dato fiable se han eliminado.', active: (a) => a.housing_prices, items: [
