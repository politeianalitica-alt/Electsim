...
const LEGENDS: Legend[] = [
  ...
  { id: 'housing', title: 'Precio vivienda €/m² · ~7.000 ciudades', note: 'España y grandes capitales: dato curado (var. interanual INE en vivo). Resto: ≈ estimado por modelo. Mapa de color visible a todos los zooms.', active: (a) => a.housing_prices, items: [
